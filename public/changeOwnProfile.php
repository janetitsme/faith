<?php
	...
	// check that customer email field is filled in
	if ($email == '')
	{
...
<?php	
	if ($results) {
		if ($num_rows > 0) {
				...
				{ ?>					
					<form name="update" method="Post" action="changeProfile.php">
						<?php $email=$row['cust_Email']; ?>
						<fieldset>
							<legend>Customer Changing their own  Profile</legend>
						<table cellspacing="30" style="margin-left:100">
							...
							<tr><td align="right"></td><td><p><input type="submit" value="Save"></p></td></tr>
						</table>
						</fieldset>
					</form>
		<?php	}
